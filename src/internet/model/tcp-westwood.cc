                        ...
                        const Time& rtt)
{
 ...
 ///std::cerr<<"MinRtt  "<<m_minRtt.GetSeconds()<<std::endl;
  //std::cerr<<"current rtt  "<<rtt.GetSeconds()<<std::endl;
...
TcpWestwood::EstimateBW (const Time &rtt, Ptr<TcpSocketState> tcb)
{
  ...
  std::cerr<< "EstimateBW: m_ackedSegments: "<<m_ackedSegments<<" "<<std::endl;
  std::cerr<< "EstimateBW: rtt: "<<rtt.GetSeconds()<<" "<<std::endl;
  ...
  if (m_fType == TcpWestwood::NONE)
  ...
  else if (m_fType == TcpWestwood::TUSTIN)
    {
     ...
     std::cerr<< "EstimateBW: filtered bdw: "<<m_currentBW<<" "<<std::endl;

...
int main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::OnOffApplication::DataRate", StringValue ("699Mbps"));
 ...
 // std::string nscStack = "liblinux2.6.26.so";
  ...
  p2p.SetDeviceAttribute ("DataRate", DataRateValue (DataRate (600 * 1000 * 1000)));
 ...
 // internet.SetTcp ("ns3::TcpVegas","Library",StringValue (nscStack));
  internet.Install (n);
